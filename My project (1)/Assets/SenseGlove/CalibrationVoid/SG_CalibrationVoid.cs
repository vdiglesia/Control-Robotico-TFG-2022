...
using SenseGlove.Scripts.Controls;
...
namespace SenseGlove.CalibrationVoid
{
		...
		protected void UpdateCurrentState()
		{
			switch (currStage)
			{
				...
				case VoidStage.MoveFingers:
					...
					timer_currStage += Time.deltaTime;
					oc_lerp = 0.5f + SG_Util.GetSine(openClose_freq, 0.5f, timer_currStage + (openCloseTime * 0.75f));
