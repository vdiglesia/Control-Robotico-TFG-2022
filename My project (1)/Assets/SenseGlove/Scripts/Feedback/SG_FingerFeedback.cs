...
namespace SenseGlove.Scripts.Feedback
{
    ...
    public class SG_FingerFeedback : SG_SimpleTracking
    {
        ...
        protected void FindForceDirection(Collider col)
        {
            ...
            entryOrigin = SG_Util.CaluclateLocalPos(Oa, colT.position, colT.rotation);
            entryPoint = SG_Util.CaluclateLocalPos(Ea, colT.position, colT.rotation);
        ...
        private void UpdateFeedback()
        {
            if (TouchedObject != null)
            {
                ...
                Vector3 O = SG_Util.CalculateAbsWithOffset(colT.position, colT.rotation, entryOrigin);
                Vector3 E = SG_Util.CalculateAbsWithOffset(colT.position, colT.rotation, entryPoint);
        ...
        protected void OnTriggerEnter(Collider other)
        {
            ...
            if (!this.IsTouching() && SG_Util.GetScript(other, out material))
            {
