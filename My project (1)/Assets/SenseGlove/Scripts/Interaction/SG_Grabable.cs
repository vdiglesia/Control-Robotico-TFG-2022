...
namespace SenseGlove.Scripts.Interaction
{
    ...
    public class SG_Grabable : SG_Interactable
    {
        ...
        public void SaveCurrentLocation()
        {
            ...
            SG_Util.CalculateBaseLocation(baseTransf, out baseStartPosition, out baseStartRotation); //save this for later
        ...
        public void ResetLocation()
        {
            ...
            SG_Util.GetCurrentBaseLocation(myTransf, baseStartParent, this.baseStartPosition, this.baseStartRotation, out currBasePos, out currBaseRot);
            if (this.physicsBody != null)
            {
        ...
        {
            get { return SG_Util.Average(this.angularVelocities); }
        }
