...
namespace SenseGlove.Scripts.Calibration
{
	...
	public class SG_CalibrationSequence : MonoBehaviour
	{
		...
		public SGEvent CalibrationFinished;
		/// <summary> Fires when calbration is aborted. </summary>
		public SGEvent CalibrationAbort;
		...
		public bool GetCalibrationPose(SGCore.Kinematics.BasicHandModel handDimensions, out SG_HandPose calibrationPose)
        {
            ...
            {
				calibrationPose = new SG_HandPose(iPose);
				return true;
            }
		...
		{
			SG_HandProfiles.RestoreDefaults(linkedGlove.TracksRightHand());
			timer_resetInstr = 0;
