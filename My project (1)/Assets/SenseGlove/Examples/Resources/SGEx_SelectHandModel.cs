...
namespace SenseGlove.Examples.Resources
{
    ...
    {
        public SGEvent ActiveHandConnect = new SGEvent();
        public SGEvent ActiveHandDisconnect = new SGEvent();
        ...
        public SG_HapticGlove ActiveGlove
        {
            get
            {
                if (this.ActiveHand != null && ActiveHand.realHandSource is SG_HapticGlove)
                {
                    return (SG_HapticGlove) this.ActiveHand.realHandSource;
                }
                return null;
            }
        }
