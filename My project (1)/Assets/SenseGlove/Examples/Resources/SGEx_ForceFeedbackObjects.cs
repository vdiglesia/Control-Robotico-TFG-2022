...
using SenseGlove.Scripts.Interaction;
...
namespace SenseGlove.Examples.Resources
{
    public class SGEx_ForceFeedbackObjects : MonoBehaviour
    {
        ...
        public void CalibrateWrist()
        {
            ...
            {
                if (this.activeHand.realHandSource is SG_HapticGlove)
                {
                    Quaternion imu;
                    if (((SG_HapticGlove)this.activeHand.realHandSource).GetIMURotation(out imu))
                    {
