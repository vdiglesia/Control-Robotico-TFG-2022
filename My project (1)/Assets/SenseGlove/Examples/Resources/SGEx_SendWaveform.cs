	...
	public class SGEx_SendWaveform : MonoBehaviour
	{
        ...
        private void OnEnable()
        {
			...
			{ 
				...
				SG_Util.SetButtonText(nextBtn, "Next Wavefrom", this.nextWaveFormKey);
			}
			if (this.prevBtn != null)
			{ 
				prevBtn.onClick.AddListener(SelectPrevious);
				SG_Util.SetButtonText(prevBtn, "Previous WaveForm", this.prevWaveFormKey);
			}
			if (this.sendBtn != null)
			{ 
				sendBtn.onClick.AddListener(SendWaveForm);
				SG_Util.SetButtonText(sendBtn, "Send Wavefrom", this.sendWaveFormKey);
			}
        }
