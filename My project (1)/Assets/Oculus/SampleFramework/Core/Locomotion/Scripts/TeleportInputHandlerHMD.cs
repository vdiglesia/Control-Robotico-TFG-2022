...
namespace Oculus.SampleFramework.Core.Locomotion.Scripts
{
	...
	public class TeleportInputHandlerHMD : TeleportInputHandler
	{
		...
		public override LocomotionTeleport.TeleportIntentions GetIntention()
		{
			...
			{
				return global::Oculus.SampleFramework.Core.Locomotion.Scripts.LocomotionTeleport.TeleportIntentions.None;
			}

			if (LocomotionTeleport.CurrentIntention == global::Oculus.SampleFramework.Core.Locomotion.Scripts.LocomotionTeleport.TeleportIntentions.Aim)
			{
				// If the user has actually pressed the teleport button, enter the preteleport state.
				if (OVRInput.GetDown(TeleportButton))
				{
					return FastTeleport ? global::Oculus.SampleFramework.Core.Locomotion.Scripts.LocomotionTeleport.TeleportIntentions.Teleport : global::Oculus.SampleFramework.Core.Locomotion.Scripts.LocomotionTeleport.TeleportIntentions.PreTeleport;
				}
			}
			...
			if (LocomotionTeleport.CurrentIntention == global::Oculus.SampleFramework.Core.Locomotion.Scripts.LocomotionTeleport.TeleportIntentions.PreTeleport)
			{
				// If they released the button, switch to Teleport.
				if (OVRInput.GetUp(TeleportButton))
				{
					// Button released, enter the teleport state.
					return global::Oculus.SampleFramework.Core.Locomotion.Scripts.LocomotionTeleport.TeleportIntentions.Teleport;
				}
				// Button still down, remain in PreTeleport so they can orient the destination if an orientation handler supports it.
				return global::Oculus.SampleFramework.Core.Locomotion.Scripts.LocomotionTeleport.TeleportIntentions.PreTeleport;
			}
			...
			{
				return global::Oculus.SampleFramework.Core.Locomotion.Scripts.LocomotionTeleport.TeleportIntentions.Aim;
			}
