...
namespace Oculus.SampleFramework.Usage.OVROverlayCanvas.Scripts
{
	...
	public class OVROverlayCanvas : MonoBehaviour
	{
		...
		void Start()
		{
			...
			_overlay = overlay.AddComponent<global::OVROverlay>();
			...
			_overlay.currentOverlayType = global::OVROverlay.OverlayType.Underlay;
