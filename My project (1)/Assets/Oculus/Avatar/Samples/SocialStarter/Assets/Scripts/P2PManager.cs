using System;
using Oculus.Avatar.Scripts;
using Oculus.Platform;
using Oculus.Platform.Models;
using UnityEngine;
using CAPI = Oculus.Avatar.Scripts.CAPI;
...
// frequency.
namespace Oculus.Avatar.Samples.SocialStarter.Assets.Scripts
{
    public class P2PManager
    {
        ...
        public void processAvatarPacket(RemotePlayer remote, ref byte[] packet, ref int offset)
        {
            ...
            IntPtr avatarPacket = CAPI.ovrAvatarPacket_Read((UInt32)remainingAvatarBuffer.Length, remainingAvatarBuffer);
