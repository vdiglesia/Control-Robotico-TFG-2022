    ...
    namespace geometry_msgs {
        public class TwistLinear : Vector3Msg {
            ...
            public override string ToString() {
                return "Vector3 [twist_linear_x=" + _x.ToString().Replace(",", ".") + ",  twist_linear_y="
                       + _y.ToString().Replace(",", ".") + ",  twist_linear_z=" + _z.ToString().Replace(",", ".") + "]";
            }
			
            public override string ToYAMLString() {
                return "\"twist_linear_x\" : " + _x.ToString().Replace(",", ".") + ", \"twist_linear_y\" : " 
                       + _y.ToString().Replace(",", ".") + ", \"twist_linear_z\" : " + _z.ToString().Replace(",", ".");
            }
        }
    }
